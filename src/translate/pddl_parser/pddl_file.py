...
def open(domain_filename=None, task_filename=None, custom=False):
    ...
    if not custom:
        ...
        return parsing_functions.parse_task(domain_pddl, task_pddl, False)

    else:
        parser = checker.PDDL_Checker()
        return parsing_functions.parse_task(domain_filename, task_filename, parser)
